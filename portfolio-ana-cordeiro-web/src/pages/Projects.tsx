// portfolio-ana-cordeiro-web/src/pages/Projects.tsx
...
// Mock de dados (Estes IDs serão usados na URL)
const projectsData = [
  {
    id: 1,
    title: "Cozinha",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
          {filteredProjects.map((project) => (
            <Link
              ...
              className="group relative aspect-4/5 overflow-hidden bg-gray-100 cursor-pointer block"
            >
              {/* Imagem com efeitos responsivos */}
              <img
                src={project.image}
                alt={project.title}
                className="w-full h-full object-cover grayscale-0 md:grayscale md:group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700 ease-in-out"
              />
